...
function NumberInCircle(props: NumberInCircleProps) {
    ...
    return (
        <Box border={borderWidth + " solid black"} borderRadius={props.borderRaduis} width={width} height={height} display="flex" justifyContent="center" alignItems="center" bgcolor={backgroundColor} color={color}>
